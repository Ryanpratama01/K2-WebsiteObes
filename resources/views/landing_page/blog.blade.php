         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <p class="blog_text">Various versions have evolved over the years, sometimes by accident,</p>
               </div>
            </div>
            </div>
            ...
            <div class="container-fluid">
               <div class="row">
                  <div class="col-md-6 padding_left_0">
                     <div class="blog_img"><img src="{{asset('assets/user/images/blog-img.png')}}"></div>
                  </div>
                  <div class="col-md-6">
                     <div class="blog_taita_main">
                        <h3 class="blog_taital_1">alex-hddife</h3>
                        <p class="ipsum_text">Randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the</p>
            ...
            <div class="footer_main">
               <div class="location_text">
                  <ul>
                     <li>
                        <a href="#">
                        <img src="images/map-icon.png"><span class="padding_left_10">Address : Loram Ipusm</span>
                        </a>
                     </li>
                     <li>
                        <a href="#">
                        <img src="images/call-icon.png"><span class="padding_left_10">Call : +01 1234567890</span>
                        </a>
                     </li>
                     <li>
                        <a href="#">
                        <img src="images/mail-icon.png"><span class="padding_left_10">Email : demo@gmail.com</span>
                        </a>
                     </li>
                  </ul>
               </div>
